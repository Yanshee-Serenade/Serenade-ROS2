...
class MessageBuilder:
    ...
    def __init__(self, use_history: bool = False):
        ...
        self.image_dir = Path("/root/.serenade/image")
        self.history_dir = Path("/root/.serenade/history")
...
你当前的状态是：`setstate idle`. 你的回答一定要依次出现 think, say 和 setstate.
...
"""
    ...
    def update_state_from_answer(self, setstate_line: str):
        ...
        new_system_prompt = self.system_prompt.replace(
